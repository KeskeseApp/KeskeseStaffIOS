...
class RootForHall: ButtonBarPagerTabStripViewController {
...
//    @IBOutlet weak var buttonBar: ButtonBarView!
   ...
   override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
            ...
            let cell1 = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "TablesForCheff") as! TablesForCheffVC
    
        let cell2 = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "StaffForChef") as! StaffForChefVC
